    ...
    return (
        <div className="flex-1 space-y-8">
            ...
            <div className="grid grid-cols-2 gap-y-8 pt-4">
                {/* Address Section */}
                <div>
                    <h4 className="text-cyan-400 text-[10px] sm:text-xs font-bold mb-1 tracking-widest uppercase">
                        {t('info.address_label')}
                    </h4>
                    <p className="text-slate-900 font-medium text-sm sm:text-base leading-tight">
                ...
                <div>
                    <h4 className="text-cyan-400 text-[10px] sm:text-xs font-bold mb-1 tracking-widest uppercase">
                        {t('info.work_hours_label')}
                    </h4>
                    <p className="text-slate-900 font-medium text-sm sm:text-base leading-tight">
                        {t('info.work_hours_value')}
                    </p>
                </div>
